...
public class GreetingController {
     ...
     * 2. curl localhost:8080/getGreeting?name=Jeeva -w "\n"
     */
    ...
    /**
     * Execution URL : curl -X POST -H "Content-Type: application/json" -d '{"content":"Jeeva"}' "http://localhost:8080/postGreeting" -w "\n"
     */
    ...
    /**
     * Execution URL : curl -X PUT localhost:8080/putGreeting/1/?content=Jeeva -w "\n"
     */
